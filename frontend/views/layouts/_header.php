            ...
            <div class="mainHeader__inner">
                ...
                <form class="mainHeader__search2" action="<?=Url::to(['site/index', 'alias' => Textpage::findOne(15)->alias])?>" method="GET">
                    ...
                    <button class="mainHeader__search2Submit" type="submit">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30.77 30"><defs><style>.cls-1{fill:#fff;}</style></defs><g><path class="cls-1" d="M19.47,0a11.3,11.3,0,1,0,11.3,11.3A11.35,11.35,0,0,0,19.47,0Zm0,19.9A8.5,8.5,0,1,1,28,11.4,8.49,8.49,0,0,1,19.47,19.9Z"></path><path class="cls-1" d="M19.47,4.4a1.37,1.37,0,0,0-1.4,1.4,1.37,1.37,0,0,0,1.4,1.4,4.23,4.23,0,0,1,4.2,4.2,1.41,1.41,0,0,0,2.81,0A7,7,0,0,0,19.47,4.4Z"></path><path class="cls-1" d="M7.67,20.3.38,27.6a1.5,1.5,0,0,0,0,2,1.26,1.26,0,0,0,1,.4,1.28,1.28,0,0,0,1-.4l7.29-7.3a1.52,1.52,0,0,0,0-2A1.52,1.52,0,0,0,7.67,20.3Z"></path></g></svg>
                    </button>
                </form>
