                ...
                <ul class="mainHeader__menu">
                    <li>
                        <a href="#" class="mainHeader__menuLink mainHeader__menuLink_catalog js-hovered js-triangle js-popup" data-popup="menu">
                            <span>Каталог</span>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 15.68 15.68"><defs><style>.cls-1gfdg{fill:none;stroke:#e83b4b;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.92px;}</style></defs><g><line class="cls-1gfdg" x1="0.96" y1="14.72" x2="14.72" y2="0.96"/><line class="cls-1gfdg" x1="0.96" y1="0.96" x2="14.72" y2="14.72"/></svg>
                        </a>
                    </li>
                    <li>
                ...
                <div class="mainHeader__right">
                    ...
                    <form class="mainHeader__search" action="<?=Url::to(['site/index', 'alias' => Textpage::findOne(15)->alias])?>" method="GET">
                        ...
                        <button class="button button2 mainHeader__searchSubmit" type="submit">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 89 32.92"><g><polygon points="7.73 1 1 6.57 1 31.92 81.27 31.92 88 26.35 88 1 7.73 1"/></svg>
                            <span>искать</span>
                        </button>
                        <svg class="mainHeader__searchClose" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22.79 22.77"><defs><style>.cls-1{fill:#fff;}</style></defs><g><path class="cls-1" d="M13.41,11.38l9-9a1.52,1.52,0,0,0,0-2,1.5,1.5,0,0,0-2,0l-9,9-9-9a1.5,1.5,0,0,0-2,0,1.42,1.42,0,0,0,0,2l9,9-9,9a1.52,1.52,0,0,0,0,2,1.31,1.31,0,0,0,1,.39,1.31,1.31,0,0,0,1-.39l9-9,9,9a1.48,1.48,0,0,0,2,0,1.52,1.52,0,0,0,0-2Z"/></svg>
                    </form>
                ...
                <div class="container">
                    <div class="mainHeader__popupMenuBottomInner">
                        ...
                        <div class="button button1 callbackButton" data-fancybox data-src="#callback">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 99.08 17.94"><g><g><polygon points="4.01 0.5 0.5 3.41 0.5 17.44 95.07 17.44 98.58 14.53 98.58 0.5 4.01 0.5"/></svg>
