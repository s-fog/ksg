    ...
    <div class="container">
        <div class="footer__cartInner">
            <div class="footer__cartLeft">
                ООО "КейЭсДжи"<br>
                Интернет-магазин спортивного инвентаря.<br>
                2018 – Все права защищены.
            </div>
            <div class="footer__cartMiddle">
                <div class="footer__cartMiddleItem">В Москве: <a href="tel:+74957775544" class="linkReverse">+7 495 777 55 44</a></div>
                <div class="footer__cartMiddleItem">Для регионов: <a href="tel:+78007775544" class="linkReverse">8 800 777 55 44</a></div>
            </div>
