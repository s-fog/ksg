...
<div class="mainHeader__popupOuter">
    <div class="mainHeader__popupCartInner">
        ...
        <div class="mainHeader__popupCartItem">
            <a href="<?=Url::to(['site/index', 'alias' => Textpage::findOne(12)->alias])?>" class="mainHeader__popupCartItemTop"><span>Добавлено к сравнению</span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 12.37 18.97"><defs><style>.cls-1{fill:#fff;}</style></defs><path class="cls-1" d="M11.41,19a1,1,0,0,1-1-1V1a1,1,0,0,1,1.92,0V18A1,1,0,0,1,11.41,19Z"/><path class="cls-1" d="M6.18,19a1,1,0,0,1-1-1V6.24a1,1,0,0,1,1.92,0V18A1,1,0,0,1,6.18,19Z"/><path class="cls-1" d="M1,19a1,1,0,0,1-1-1v-7.5a1,1,0,0,1,1.92,0V18A1,1,0,0,1,1,19Z"/></svg></a>
            <div class="mainHeader__popupCartItemBottom">
        ...
        <div class="mainHeader__popupCartItem">
            <a href="<?=Url::to(['site/index', 'alias' => Textpage::findOne(11)->alias])?>" class="mainHeader__popupCartItemTop"><span>В избранном</span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16.09 16.2"><defs><style>.cls-1{fill:#fff;}</style></defs><path class="cls-1" d="M8.05,16.2A1,1,0,0,1,7.42,16C6.66,15.32,0,9.47,0,5.08,0,1.06,2.79,0,4.27,0A4.33,4.33,0,0,1,8.05,1.87,4.3,4.3,0,0,1,11.82,0c1.48,0,4.27,1.06,4.27,5.08,0,4.39-6.66,10.24-7.42,10.89A1,1,0,0,1,8.05,16.2ZM4.27,1.92c-.38,0-2.35.2-2.35,3.16,0,2.69,4,6.9,6.13,8.88,2.15-2,6.12-6.19,6.12-8.88,0-3.07-2.11-3.16-2.35-3.16C9.08,1.92,9,4.72,9,5A1,1,0,1,1,7.09,5C7.08,4.73,7,1.92,4.27,1.92Z"/></svg></a>
            <div class="mainHeader__popupCartItemBottom">
