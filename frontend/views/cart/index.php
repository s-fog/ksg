    ...
    <div class="empty">
        <div class="container">
            <div class="empty__inner">
                <div class="empty__left" style="background-image: url(/img/cartEmpty.png);"></div>
                <div class="empty__right">
                    <div class="empty__header">корзина пуста</div>
                    <div class="empty__text">Но это легко исправить! Под каждым товаром в нашем магазине Вы найдёте кнопку «купить» или «добавить в корзину». После этого в данном разделе отображаются выбранные товары и сумма покупки. Также Вы сможете изменить количество товара или убрать его из корзины.</div>
