                            ...
                            <a href="<?=Url::to(['catalog/view', 'alias' => $product->alias])?>" class="compare__productsItem">
                                <span class="compare__productsItemTop">
                                    <span class="catalog__itemTop">
                                        <span title="Удалить из сравнения"
                                              data-id="<?=$product->id?>"
                                              class="catalog__itemCompareDelete js-delete-from-compare"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30.14 34.01"><g><path class="cls-1" d="M30.1,7c-.86-3.72-7.54-4.17-12.24-4.15a2.88,2.88,0,0,0-5.76.06v0C7.89,2.94,0,3.32,0,7.36a3.13,3.13,0,0,0,1.84,2.73Q3.07,21.32,4.32,32.56A1.48,1.48,0,0,0,5.76,34H24.39a1.49,1.49,0,0,0,1.45-1.45q1.23-11.24,2.48-22.48A3.82,3.82,0,0,0,30.1,7.74a1.83,1.83,0,0,0,0-.76Zm-7,24.14H7.05L5,12.12a45.55,45.55,0,0,0,10.12,1.36A48.21,48.21,0,0,0,25.19,12.2S23.8,24.81,23.11,31.12ZM14.75,10.36C8.5,10.36,3.66,9,3.66,7.55S8.73,5.37,15,5.37s11.33.74,11.33,2.18S21,10.36,14.75,10.36Zm-.91,6.5V27.22a1.45,1.45,0,0,0,2.89,0V16.86A1.45,1.45,0,0,0,13.84,16.86ZM21,27.22Q21.5,22,22,16.86c.18-1.85-2.71-1.83-2.89,0q-.54,5.19-1.06,10.36C17.9,29.07,20.79,29.06,21,27.22ZM11.43,16.86c-.18-1.83-3.08-1.85-2.89,0q.54,5.19,1.06,10.36c.19,1.84,3.08,1.86,2.89,0Q12,22,11.43,16.86Z"/></svg></span>
                                        <span title="Добавить в корзину"
                                              data-id="<?=$product->id?>"
                                              data-paramsV="<?=($currentVariant->params) ? implode('|', $currentVariant->params) : ''?>"
                                              data-quantity="1"
                                              class="catalog__itemCart js-add-to-cart"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40.6 28.6"><defs><style>.cls-1{fill:#fff;}</style></defs><g><path class="cls-1" d="M17,21.8a3.4,3.4,0,1,0,3.4,3.4A3.37,3.37,0,0,0,17,21.8Zm0,4a.6.6,0,1,1,.6-.6A.65.65,0,0,1,17,25.8Z"></path><path class="cls-1" d="M35.5,21.8a3.4,3.4,0,1,0,3.4,3.4A3.44,3.44,0,0,0,35.5,21.8Zm0,4a.6.6,0,1,1,.6-.6A.65.65,0,0,1,35.5,25.8Z"></path><path class="cls-1" d="M39.2,4.8H13.6l-.7-3.7A1.32,1.32,0,0,0,11.5,0H1.4A1.37,1.37,0,0,0,0,1.4,1.37,1.37,0,0,0,1.4,2.8h8.9l2.8,14.8a1.32,1.32,0,0,0,1.4,1.1H35.4a1.4,1.4,0,0,0,0-2.8H15.6l-.5-2.8H37.7a1.4,1.4,0,0,0,0-2.8H14.6l-.5-2.8H39.2a1.37,1.37,0,0,0,1.4-1.4A1.29,1.29,0,0,0,39.2,4.8Z"></path></svg></span>
                                    </span>
                                </span>
