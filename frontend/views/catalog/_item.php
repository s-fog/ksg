...
<div class="catalog__item" data-id="<?=$model->id?>">
    <div class="catalog__itemTop">
        <a href="#"
           class="catalog__itemCart hint hint_tocart catalog__itemToCart"
           data-fancybox
