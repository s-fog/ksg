                ...
                <div class="mainSlider__itemInner">
                    ...
                    <?php if (!empty($item->link)) { ?>
                        <a href="<?=$item->link?>" class="button button4 mainSlider__itemMore">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 140 34"><polygon class="cls-1" points="108.93 0 14.43 0 8.13 0 0 6.73 0 34 14.49 34 109 34 131.87 34 140 27.27 140 0 108.93 0"/></svg>
                            <span>подробнее</span>
                        </a>
                    <?php } ?>
                </div>
            ...
            $form = ActiveForm::begin([
                ...
                <div class="subscribeBlock__formFieldset">
                    ...
                    <button class="button button6 subscribeBlock__formSubmit" type="submit">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 79.08 17.94"><polygon points="4.01 0.5 0.5 3.41 0.5 17.44 75.07 17.44 78.58 14.53 78.58 0.5 4.01 0.5"/></svg>
