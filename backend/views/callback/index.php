...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var common\models\CallbackSearch $searchModel
*/

$this->title = Yii::t('models', 'Callbacks');
...
$statuses = Yii::$app->params['callbackStatus'];
?>
<div class="giiant-crud callback-index">
